...
use cmox::{initialize, mac::{HmacSha256, AesCmac}};
...
pub extern "C" fn main() {
    ...
    // HMAC-SHA256 Example using native API
    {
        ...
        hmac_verify.update_internal(data).expect("Failed to update HMAC");
        let verify_tag = hmac_verify.finalize_internal().expect("Failed to finalize HMAC");
    ...
    // AES-CMAC Example using native API
    {
        ...
        cmac_verify.update_internal(data).expect("Failed to update CMAC");
        let verify_tag = cmac_verify.finalize_internal().expect("Failed to finalize CMAC");
    ...
    // Multiple update example
    {
        ...
        hmac.update_internal(b"Part 1 of message").expect("Failed to update");
        hmac.update_internal(b" - Part 2 of message").expect("Failed to update");
        hmac.update_internal(b" - Final part").expect("Failed to update");
        ...
        hmac_single.update_internal(b"Part 1 of message - Part 2 of message - Final part").expect("Failed to update");
