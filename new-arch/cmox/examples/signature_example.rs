...
use cmox::{
    ...
    rng::CtrDrbg,
    signature::{
        CurveType, EcdsaSignature, EcdsaSigningKey, EcdsaVerifyingKey, EddsaSignature,
        EddsaSigningKey, EddsaVerifyingKey, EdwardsCurve, RsaHashAlgorithm, RsaKeySize,
        RsaSignature, RsaSigningKey, RsaVerifyingKey, Sm2Curve, Sm2Signature, Sm2SigningKey,
        Sm2VerifyingKey,
    },
    CmoxError,
};
...
fn eddsa_signature_example() {
    ...
    // Ed448 Example
    {
        ...
        match (
            ...
            (Ok(signing_key), Ok(verifying_key)) => {
                let message =
                    b"EdDSA Ed448 signature test with longer message for testing purposes";
